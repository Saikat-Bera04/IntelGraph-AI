    ...
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-12 lg:py-24">
        ...
        <div className="text-center max-w-5xl mx-auto mb-10">
          ...
          >
            <span className="text-balance">GraphRAG-powered</span>
            <br />
            <span className="text-balance">cybersecurity</span>{" "}
          ...
          >
            Analyzes attack chains using multi-hop graph reasoning, reducing LLM token usage while improving threat intelligence accuracy.
          </p>
        </div>
        ...
        >
          {[
            { value: "-85%", label: "Token Usage vs Base LLM", company: "EFFICIENCY" },
            { value: "4x", label: "Faster Context Retrieval", company: "LATENCY" },
            { value: "98%", label: "Attack Path Accuracy", company: "PRECISION" },
            { value: "100%", label: "Evidence Traceability", company: "EXPLAINABILITY" },
          ].map((stat) => (
