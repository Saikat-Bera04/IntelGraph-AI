...
const features = [
  {
    ...
    description: "Extract entities, traverse graph relationships, and find connected attack chains instantly.",
    animationKey: "neural" as const,
  },
  {
    title: "Interactive Attack Graph",
    description: "Visual graph showing threat actors, malware, IPs, domains, CVEs, and organizations.",
    animationKey: "workflow" as const,
  },
  {
    title: "Explainable AI",
    description: "See exactly why an answer was generated with full graph traversal paths and connected evidence chains.",
    animationKey: "security" as const,
  },
  {
    title: "Triple-Pipeline Benchmark",
    description: "Compare LLM Only, Basic RAG, and GraphRAG side-by-side with real-time metrics.",
    animationKey: "analytics" as const,
  },
  {
    title: "Context Compression",
    description: "Send optimized context to the LLM, reducing tokens and latency while retaining critical intelligence.",
    animationKey: "globe" as const,
  },
  {
    title: "Dataset Explorer",
    description: "Browse comprehensive datasets including threat actors, CVEs, malware families, and campaigns.",
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          <div>
            <p className="text-sm font-mono text-primary mb-3">// CAPABILITIES</p>
            <h2
              className={`text-3xl lg:text-5xl font-semibold tracking-tight mb-6 transition-all duration-700 ${
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
              }`}
            >
              <span className="text-balance">Multi-Hop Cyber</span>
              <br />
              <span className="text-balance">Reasoning</span>
            </h2>
            <p
            ...
            >
              Investigate ransomware campaigns, malware infrastructure, exploit chains, and attacker relationships with multi-hop graph reasoning.
            </p>
          </div>
