      ...
      >
        <div className="glass-panel p-8 rounded-2xl border border-border/50 relative z-10 card-shadow">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-semibold mb-2">Request Clearance</h1>
            <p className="text-muted-foreground text-sm">Create an account to deploy the GraphRAG engine.</p>
          </div>
          ...
          <form onSubmit={handleSignUp} className="space-y-4">
            ...
            <Button 
              type="submit" 
              className="w-full h-11 bg-primary text-primary-foreground hover:bg-primary/90 mt-6 font-medium"
              disabled={isLoading}
            >
              {isLoading ? "Provisioning Access..." : "Create Account"}
